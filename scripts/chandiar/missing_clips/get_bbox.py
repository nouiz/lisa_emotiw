...
def get_bbox(extracted_frames_path, ramanan_keypts_path, bbox_path, bbox_on_img_path):
    #no_keypoints = []
    #info = []
    #keypts ={}
...
if __name__ == '__main__':
    ...
    debug = False
    if debug:
        missing_clips = ['003044960', '005242000', '010924040', '013736360', '014429160']
        for clip in missing_clips:
            extracted_frames_path = '/data/lisa/exp/chandiar/Challenge/temp/ExtractedFrame/%s/'%clip#sys.argv[1]
            ramanan_keypts_path = '/data/lisa/exp/chandiar/Challenge/temp/ExtractedFrame/%s/'%clip#sys.argv[2]
            bbox_path = '/data/lisa/exp/chandiar/Challenge/temp/BoundBoxData/%s'%clip#sys.argv[3]
            if True:
                bbox_on_img_path = '/data/lisa/exp/chandiar/Challenge/temp/bbox_on_image/%s'%clip#sys.argv[4]
            else:

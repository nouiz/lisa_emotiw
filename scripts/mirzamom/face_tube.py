...
def main():
    ...
    save_path = '/data/lisa/data/faces/EmotiW/picasa_face_tubes/v2/'
    ...
    for set_n in sets:
        ...
        for emot in emots:
            ...
            #clips = ['012048128']
            #clips = ['011326080', '004447734', '002816934']
            ...
            failed = []
            face_tubes = get_face_tubes(frames, bx, failed, "{}{}/{}/".format(frame_path, set_n, emot), "{}{}/{}/".format(save_path, set_n, emot), "{}{}/{}/".format(tubes_full_path, set_n, emot), distance_thr, size_thre, overlap_thr, similar_thr)

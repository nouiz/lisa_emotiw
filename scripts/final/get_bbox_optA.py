...
if __name__ == '__main__':
    # python get_bbox.py arg1 arg2 arg3 [arg4]
    # python get_bbox.py /u/ebrahims/emotiw_pipeline/validation_set/ramanan_keypoints_picassa_backup/000147200
    ...
    #   arg1 is the path to the folder containing the extracted frames for the given video clip (.png)
    #   arg2 is the path to the ramanan mat file for the given video clip (.mat)
    #   arg3 is the path to the folder where we will save the bounding boxes coordinates (.txt)
    #   arg4 is the path to the folder where we will save the images with the bounding boxes drawn (.png), this is an optional argument
    if debug:

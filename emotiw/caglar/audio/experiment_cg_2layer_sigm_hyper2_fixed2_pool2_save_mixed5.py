...
import numpy
import theano
import emotiw.caglar.audio.ml as ml
...
def jobman_insert_random(n_jobs, table_name="emotiw_mlp_audio_sigm_fixed_pool2_mixed5"):

    JOBDB = 'postgresql://gulcehrc@opter.iro.umontreal.ca/gulcehrc_db?table=' + table_name
    EXPERIMENT_PATH = "experiment_cg_2layer_sigm_hyper2_fixed2_pool2_save_mixed5.jobman_entrypoint"
    nlr = 45
...
def jobman_insert():
    ...
    EXPERIMENT_PATH = "experiment_cg_2layer_hyper2.jobman_entrypoint"
    JOB_VALS = {
        'n_hiddens' : [1024],
        'n_layers' : [1],
...
def view(table="emotiw_mlp_audio_sigm_fixed_pool2_mixed5",
         tag="sigm_norm_const_fixed_pool2_mixed5",
         user="gulcehrc",
         password="",

...
def main(n_hiddens=400,
    ...
    layers = n_layers * [('R', n_hiddens)] +  [('S', train_y.max() + 1)]
...
def view(table="emotiw_mlp_audio_sigm_fixed_pool2_mixed5_nrelu",
         tag="sigm_norm_const_fixed_pool2_mixed5_nrelu",
         user="gulcehrc",
         password="",
    ...
    columns = [experiments.columns.id,
               experiments.columns.jobmanstatus,
               ...
               experiments.columns.hiddendropout,

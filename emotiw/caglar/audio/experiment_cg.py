...
def main(n_hiddens=400,
    ...
    for epoch in range(train_epochs):
        ...
        if train_error < best_train_error:
            ...
            model.trainer.learning_rate.set_value(numpy.asarray(0.98 * model.trainer.learning_rate.get_value(), dtype=theano.config.floatX))
...
def view(table="emotiw_mlp_audio_tanh",
         tag="tanh_norm_const",
         user="gulcehrc",
         password="",
...
if __name__ == "__main__":
    if "insert" in sys.argv:
        ...
        #main()
        main(n_hiddens=360,
            learning_rate=0.03915195014115,
            momentum=0.7406261015,
            features="full.pca",
            example_dropout=100,
            hidden_dropout=0.6,
            nlayers=3,

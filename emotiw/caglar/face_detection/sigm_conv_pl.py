...
class ConvLinear(Layer):
    ...
    def fpropActivation(self, z):
        return z
        
class ConvRectifiedLinear(ConvLinear):
    
    def __init__(self, **kwargs):
        self.left_slope = kwargs.pop('left_slope', 0.0)
        super(ConvRectifiedLinear, self).__init__(**kwargs)
...
class ConvSigmoid(ConvLinear):
    ...
    def __init__(self, **kwargs):
        super(ConvSigmoid, self).__init__(**kwargs)
    ...
    def cost(self, Y, Y_hat):
        ...
        term_1 = Y * T.log(Y)
        term_2 = Y * T.log(Y_hat)
        term_3 = (1-Y) * T.log(1-Y)
        term_4 = (1-Y) * T.log(1-Y_hat)
